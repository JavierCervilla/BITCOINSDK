...
exports.DispensesList = void 0;
const dntShim = __importStar(require("../../../../../_dnt.shims.js"));
const react_1 = __importDefault(require("react"));
const react_2 = require("react");
const react_window_1 = require("react-window");
const DispenseItem_component_js_1 = require("./DispenseItem.component.js");
...
const DispensesListComponent = ({ dispenses, isLoading, btcPrice }) => {
    ...
    if (dispenses.length === 0) {
        return (react_1.default.createElement("div", { className: "text-center py-4 text-secondary flex flex-col gap-2" },
            react_1.default.createElement("span", { className: "text-sm font-medium" }, "No Dispense sales available")));
    }
    return (react_1.default.createElement("div", { className: "flex flex-col gap-2 max-h-[calc(100vh-200px)] md:max-h-[200px] overflow-auto" },
        ...
        react_1.default.createElement(react_window_1.FixedSizeList, { height: MAX_HEIGHT, itemCount: dispenses.length, itemSize: ROW_HEIGHT, width: "100%" }, ({ index, style }) => {
            const dispense = dispenses[index];
            return (react_1.default.createElement("div", { style: style },
                react_1.default.createElement(DispenseItem_component_js_1.DispenseItem, { key: dispense.tx_hash, btcPrice: btcPrice, dispense: dispense })));
        })));
};
exports.DispensesList = (0, react_2.memo)(DispensesListComponent);
