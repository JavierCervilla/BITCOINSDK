...
exports.DispensersList = void 0;
const dntShim = __importStar(require("../../../../../_dnt.shims.js"));
const react_1 = __importDefault(require("react"));
const react_2 = require("react");
const react_window_1 = require("react-window");
const DispenserItem_component_js_1 = require("./DispenserItem.component.js");
...
function DispensersListComponent({ dispensers, isLoading, btcPrice }) {
    ...
    if (dispensers.length === 0) {
        return (react_1.default.createElement("div", { className: "text-center py-4 text-secondary flex flex-col  gap-2" },
            react_1.default.createElement("span", { className: "text-sm font-medium" }, "No Dispenser sales available")));
    }
    return (react_1.default.createElement("div", { className: "flex flex-col gap-2 max-h-[calc(100vh-200px)] md:max-h-[200px]" },
        react_1.default.createElement("div", { className: "flex flex-col gap-2 overflow-auto" },
            react_1.default.createElement("div", { className: "hidden md:flex flex-row justify-between items-center gap-2 p-2 bg-light border-b border-primary text-primary" },
                ...
                react_1.default.createElement("span", { className: "text-sm font-medium w-1/5" }, "Remaining"),
            ...
            react_1.default.createElement(react_window_1.FixedSizeList, { height: MAX_HEIGHT, itemCount: dispensers.length, itemSize: ROW_HEIGHT, width: "100%" }, ({ index, style }) => {
                const dispenser = dispensers[index];
                return (react_1.default.createElement("div", { style: style },
                    react_1.default.createElement(DispenserItem_component_js_1.DispenserItem, { btcPrice: btcPrice, key: dispenser.tx_hash, dispenser: dispenser })));
            }))));
}
exports.DispensersList = (0, react_2.memo)(DispensersListComponent);
