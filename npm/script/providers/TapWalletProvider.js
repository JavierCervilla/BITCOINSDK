...
exports.pushTXTapWallet = exports.signPSBTWithTapWallet = exports.signMessageWithTapWallet = exports.connectTapWallet = void 0;
// src/providers/TapWalletProvider.ts
const dntShim = __importStar(require("../_dnt.shims.js"));
const connectTapWallet = async () => {
...
exports.connectTapWallet = connectTapWallet;
const signMessageWithTapWallet = async (message) => {
    const tapwallet = globalThis.tapwallet;
    const signature = await tapwallet.signMessage(message);
    return signature;
};
exports.signMessageWithTapWallet = signMessageWithTapWallet;
const signPSBTWithTapWallet = async (psbt, options) => {
    if (typeof dntShim.dntGlobalThis !== "undefined" && globalThis.tapwallet) {
        try {
            if (options) {
                const opt = {};
...
exports.signPSBTWithTapWallet = signPSBTWithTapWallet;
const pushTXTapWallet = async (txHex) => {
    if (typeof dntShim.dntGlobalThis !== "undefined" && globalThis.tapwallet) {
        try {
...
exports.pushTXTapWallet = pushTXTapWallet;
