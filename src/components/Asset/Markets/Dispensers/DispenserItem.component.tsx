...
export function DispenserItem({ dispenser, btcPrice }: DispenserItemProps) {
  return (
    <div className="flex flex-col md:flex-row gap-2 p-4 justify-between transition-colors border rounded-lg md:border-b border-primary hover:bg-light/5">
      <div className="flex flex-col md:w-1/4 gap-1 m-auto">
        ...
        <span className="text-sm font-mono truncate" title={dispenser.give_quantity_normalized}>
      ...
      <div className="flex flex-col md:w-1/4 gap-1 m-auto">
        ...
        <span className="text-sm font-mono truncate" title={dispenser.price.toString()}>
          {(dispenser.satoshi_price).toLocaleString()} sats
        </span>
        <span className="text-xs font-mono truncate" title={dispenser.price.toString()}>
      ...
      <div className="flex flex-col md:w-1/4 gap-1 m-auto">
        ...
        <span className="text-sm font-mono truncate" title={dispenser.satoshirate.toString()}>
      ...
      <div className="flex flex-col md:w-1/4 gap-1 m-auto">
        ...
        <span className="text-sm font-mono truncate" title={new Date(dispenser.block_time * 1000).toLocaleString()}>
