...
export const signMessageWithUnisat = async (message: string) => {
...
export const signPSBTWithUnisat = async (
  psbt: string,
...
export const pushTXUnisat = async (txHex: string): Promise<string | null> => {
  if (typeof globalThis !== "undefined" && globalThis.unisat) {
    try {
